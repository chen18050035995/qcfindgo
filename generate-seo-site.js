...
const agentIcons = {
  ...
  "CNFans": "https://www.google.com/s2/favicons?domain=cnfans.com&sz=128",
...
const gscPriorityLinks = [
  ...
  { href: "/keywords/qcfindgo-official/", label: "qcfindgo Official" },
  { href: "/keywords/qc-brand-search/", label: "QC Brand Search" },
  { href: "/keywords/qc-finder/", label: "QC Finder" },
  { href: "/keywords/qc-finder-spreadsheet/", label: "QC Finder Spreadsheet" },
  { href: "/keywords/qc-finds/", label: "QC Finds" },
  { href: "/keywords/qc-finds-spreadsheet/", label: "QC Finds Spreadsheet" },
  { href: "/keywords/nike-qc/", label: "Nike QC" },
  { href: "/keywords/nike-qc-photos/", label: "Nike QC Photos" },
  ...
  { href: "/keywords/nike-dunk-low-qc-photos/", label: "Nike Dunk Low QC Photos" },
  { href: "/keywords/dior-b30-w2c/", label: "Dior B30 W2C" },
  { href: "/keywords/lv-trainer-qc/", label: "LV Trainer QC" },
  { href: "/keywords/designer-sneakers-spreadsheet/", label: "Designer Sneakers Spreadsheet" },
  { href: "/keywords/qc-photos/", label: "QC Photos" },
  { href: "/keywords/qc-hoodie/", label: "QC Hoodie" },
  { href: "/keywords/qc-bags/", label: "QC Bags" },
  { href: "/keywords/qc-official-website/", label: "QC Official Website" },
  { href: "/keywords/qc-pants/", label: "QC Pants" },
  { href: "/keywords/sneaker-qc-finder/", label: "Sneaker QC Finder" },
  { href: "/keywords/cnfans-spreadsheet/", label: "CNFans Spreadsheet" },
  { href: "/keywords/mulebuy-spreadsheet/", label: "Mulebuy Spreadsheet" },
  { href: "/keywords/allchinabuy-spreadsheet/", label: "AllChinaBuy Spreadsheet" },
  { href: "/keywords/superbuy-spreadsheet/", label: "Superbuy Spreadsheet" },
  { href: "/keywords/cssbuy-spreadsheet/", label: "CSSBuy Spreadsheet" },
  { href: "/keywords/oopbuy-spreadsheet/", label: "Oopbuy Spreadsheet" },
  { href: "/compare/kakobuy-vs-mulebuy/", label: "Kakobuy vs Mulebuy" },
  { href: "/compare/cssbuy-vs-superbuy/", label: "CSSBuy vs Superbuy" },
  { href: "/keywords/loro-piana-spreadsheet/", label: "Loro Piana Spreadsheet" },
  { href: "/keywords/loro-piana-w2c/", label: "Loro Piana W2C" },
  { href: "/compare/oopbuy-vs-superbuy/", label: "Oopbuy vs Superbuy" },
  { href: "/keywords/bq-sneakers/", label: "BQ Sneakers" },
  { href: "/keywords/bq-sneakers-spreadsheet/", label: "BQ Sneakers Spreadsheet" },
...
const keywordLandingPages = [
  ...
  { slug: "qcfindgo-official", title: "qcfindgo Official", terms: ["sneaker"], fallback: "/keywords/qc-official-website/", description: "Use this qcfindgo official landing page to route brand searches toward QC photos, QC finder pages, W2C links, item IDs, category pages, and Nova Finds Go order paths.", phrases: ["qcfindgo official", "qc official website", "qcfinder official", "qcfinds official"] },
  { slug: "qc-brand-search", title: "QC Brand Search", terms: ["sneaker"], fallback: "/keywords/qcfin/", description: "Use this QC brand search page for qcfin, qcfinda, qcfindes, qcfinder, qcfinds, and related misspellings that users type while looking for qcfindgo product routes.", phrases: ["qcfin", "qcfinda", "qcfindes", "qcfinder", "qcfinds"] },
  ...
  { slug: "qc-finder-spreadsheet", title: "QC Finder Spreadsheet", terms: ["sneaker"], fallback: "/keywords/qc-finder/", description: "Browse QC finder spreadsheet-style pages with product photos, item IDs, W2C links, prices, brand pages, category pages, and Nova Finds Go buying routes.", phrases: ["qc finder spreadsheet", "qcfinds spreadsheet", "qc finds spreadsheet", "qc finder W2C"] },
  ...
  { slug: "qc-finds-spreadsheet", title: "QC Finds Spreadsheet", terms: ["sneaker"], fallback: "/keywords/qc-finds/", description: "Use this QC finds spreadsheet page to compare sneaker, hoodie, bag, and designer product pages with QC photos, W2C links, item IDs, prices, and buyer routes.", phrases: ["qc finds spreadsheet", "qcfinds spreadsheet", "qcfindgo spreadsheet", "qc finds W2C"] },
  ...
  { slug: "nike-qc-photos", title: "Nike QC Photos", terms: ["nike"], fallback: "/keywords/nike-qc/", description: "Browse Nike QC photos across sneakers, hoodies, tees, item IDs, W2C links, prices, product pages, and Nova Finds Go buying routes.", phrases: ["nike qc photos", "nike qc", "nike sneaker qc photos", "Nike reps QC photos"] },
  ...
  { slug: "nike-dunk-low-qc-photos", title: "Nike Dunk Low QC Photos", terms: ["nike", "dunk"], fallback: "/keywords/nike-dunk-low-reps/", description: "Review Nike Dunk Low QC photos for toe box shape, swoosh placement, heel tab, sole color, item IDs, W2C links, and order routes.", phrases: ["nike dunk low qc photos", "Nike Dunk Low QC", "Nike Dunk QC", "Dunk Low W2C"] },
  { slug: "nike-air-force-1-qc-photos", title: "Nike Air Force 1 QC Photos", terms: ["nike", "air force"], fallback: "/keywords/nike-air-force-1-reps/", description: "Compare Nike Air Force 1 QC photos for leather texture, toe shape, swoosh placement, heel tab, sole details, item IDs, and W2C links.", phrases: ["nike air force 1 qc photos", "AF1 QC photos", "Nike AF1 reps QC"] },
  { slug: "adidas-samba-w2c", title: "Adidas Samba W2C", terms: ["adidas", "samba"], fallback: "/keywords/adidas-samba-qc/", description: "Find Adidas Samba W2C links with QC photos, sole shape checks, sizing notes, product IDs, prices, and Nova Finds Go buying routes.", phrases: ["adidas samba w2c", "Adidas Samba W2C links", "Samba reps W2C"] },
  { slug: "dior-b30-w2c", title: "Dior B30 W2C", terms: ["dior", "b30"], fallback: "/keywords/dior-b30-qc/", description: "Browse Dior B30 W2C pages with QC photos, panel shape checks, logo placement notes, item IDs, prices, and buyer routes.", phrases: ["dior b30 w2c", "Dior B30 W2C link", "Dior B30 reps QC"] },
  { slug: "lv-bag-spreadsheet", title: "LV Bag Spreadsheet", terms: ["louis vuitton", "bag"], fallback: "/keywords/lv-bag-qc/", description: "Use this LV bag spreadsheet page to compare QC photos, canvas alignment, hardware checks, W2C links, item IDs, prices, and product routes.", phrases: ["lv bag spreadsheet", "Louis Vuitton bag spreadsheet", "LV bag W2C"] },
  { slug: "gucci-shoes-spreadsheet", title: "Gucci Shoes Spreadsheet", terms: ["gucci", "shoe"], fallback: "/keywords/gucci-shoes-qc/", description: "Browse Gucci shoes spreadsheet finds with QC photos, sole profile checks, logo placement, W2C links, item IDs, prices, and buying routes.", phrases: ["gucci shoes spreadsheet", "Gucci shoes W2C", "Gucci shoes reps QC"] },
  { slug: "best-rep-shoes-for-us-buyers", title: "Best Rep Shoes for US Buyers", terms: ["sneaker", "shoe"], fallback: "/keywords/w2c-sneakers-for-us-buyers/", description: "Compare the best rep shoes for US buyers with QC photos, sizing checks, W2C links, item IDs, prices, and Nova Finds Go product routes.", phrases: ["best rep shoes for us buyers", "rep shoes US buyers", "best sneaker reps US"] },
  { slug: "best-designer-bags-for-europe-buyers", title: "Best Designer Bags for Europe Buyers", terms: ["bag", "dior", "gucci", "louis vuitton"], fallback: "/keywords/designer-finds-for-europe-buyers/", description: "Compare designer bags for Europe buyers with QC photos, hardware checks, W2C links, item IDs, prices, and buyer route notes.", phrases: ["best designer bags Europe buyers", "designer bag reps Europe", "bag QC Europe"] },
  { slug: "nike-tech-fleece-qc", title: "Nike Tech Fleece QC", terms: ["nike", "fleece"], fallback: "/brands/nike/", description: "Review Nike Tech Fleece QC photos, zipper details, panel shape, logo placement, sizing notes, item IDs, W2C links, and buyer routes.", phrases: ["nike tech fleece qc", "Nike Tech Fleece reps", "Nike Tech QC photos"] },
  { slug: "adidas-campus-qc", title: "Adidas Campus QC", terms: ["adidas", "campus"], fallback: "/brands/adidas/", description: "Compare Adidas Campus QC photos, suede texture, stripe placement, sole shape, sizing notes, item IDs, W2C links, and product pages.", phrases: ["adidas campus qc", "Adidas Campus reps", "Adidas Campus QC photos"] },
  { slug: "lv-trainer-qc", title: "LV Trainer QC", terms: ["louis vuitton", "trainer"], fallback: "/brands/louis-vuitton/", description: "Check LV Trainer QC photos for panel shape, monogram details, sole profile, stitching, item IDs, W2C links, prices, and buying routes.", phrases: ["lv trainer qc", "Louis Vuitton Trainer QC", "LV Trainer reps"] },
  { slug: "dior-b22-qc", title: "Dior B22 QC", terms: ["dior", "b22"], fallback: "/brands/dior/", description: "Browse Dior B22 QC photos with shape checks, mesh and panel details, logo placement, sole profile, item IDs, W2C links, and prices.", phrases: ["dior b22 qc", "Dior B22 reps", "Dior B22 W2C"] },
  { slug: "gucci-bag-qc", title: "Gucci Bag QC", terms: ["gucci", "bag"], fallback: "/keywords/gucci-bag-reps/", description: "Review Gucci bag QC photos, hardware checks, stitching, GG logo placement, material texture, item IDs, W2C links, and buyer routes.", phrases: ["gucci bag qc", "Gucci bag QC photos", "Gucci bag W2C"] },
  { slug: "designer-sneakers-spreadsheet", title: "Designer Sneakers Spreadsheet", terms: ["sneaker", "dior", "gucci", "louis vuitton"], fallback: "/categories/designer-shoes/", description: "Use this designer sneakers spreadsheet page to compare Dior, Gucci, LV, Nike, Adidas QC photos, W2C links, item IDs, prices, and buyer routes.", phrases: ["designer sneakers spreadsheet", "designer shoes spreadsheet", "designer sneaker reps QC"] },
  { slug: "best-qc-finder-for-sneakers", title: "Best QC Finder for Sneakers", terms: ["sneaker"], fallback: "/keywords/qc-finder/", description: "Find the best QC finder pages for sneakers with product photos, item IDs, W2C links, prices, buyer notes, and Nova Finds Go order routes.", phrases: ["best qc finder for sneakers", "sneaker qc finder", "QC finder sneakers"] },
  { slug: "w2c-designer-shoes", title: "W2C Designer Shoes", terms: ["designer-shoes", "shoe"], fallback: "/categories/designer-shoes/", description: "Browse W2C designer shoes with QC photos, brand filters, product IDs, prices, agent-ready links, and US or Europe buyer notes.", phrases: ["w2c designer shoes", "designer shoes w2c", "designer shoes QC photos"] },
  { slug: "qc-photos", title: "QC Photos", terms: ["sneaker"], fallback: "/blog/how-to-use-qc-photos-before-buying-streetwear/", description: "Browse QC photos for sneakers, hoodies, designer shoes, bags, item IDs, W2C links, prices, and Nova Finds Go buying routes.", phrases: ["qc photos", "reps qc photos", "QC photo finder"] },
  { slug: "reps-qc", title: "Reps QC", terms: ["sneaker"], fallback: "/keywords/qc-photo-checklist-for-reps/", description: "Use this reps QC page to compare product photos, seller item IDs, prices, W2C links, agent-ready pages, and buyer checklist notes.", phrases: ["reps qc", "rep QC", "QC reps"] },
  { slug: "qc-hoodie", title: "QC Hoodie", terms: ["hoodie"], fallback: "/categories/hoodies/", description: "Compare QC hoodie finds with product photos, logo placement, print checks, sizing notes, item IDs, W2C links, and order routes.", phrases: ["qc hoodie", "hoodie qc", "find the good hoodie"] },
  { slug: "qc-bags", title: "QC Bags", terms: ["bag"], fallback: "/categories/designer-bags/", description: "Browse QC bags with photo checks for stitching, hardware, logo placement, materials, prices, W2C links, item IDs, and buyer routes.", phrases: ["qc bags", "qc bag price", "bag QC photos"] },
  { slug: "goyard-bag-qc", title: "Goyard Bag QC", terms: ["goyard", "bag"], fallback: "/keywords/qc-bags/", description: "Review Goyard bag QC photos, print alignment, stitching, leather trim, item IDs, W2C links, prices, and buyer route notes.", phrases: ["qc goyard bag", "goyard bag qc", "Goyard bag QC photos"] },
  { slug: "hellstar-set-qc", title: "Hellstar Set QC", terms: ["hellstar", "set"], fallback: "/finds/", description: "Compare Hellstar set QC photos, print placement, fabric texture, sizing notes, item IDs, W2C links, prices, and order routes.", phrases: ["hellstar set", "Hellstar set QC", "Hellstar reps set"] },
  { slug: "stone-island-qc", title: "Stone Island QC", terms: ["stone island"], fallback: "/brands/stone-island/", description: "Browse Stone Island QC finds with badge checks, material notes, product photos, item IDs, W2C links, prices, and buyer routes.", phrases: ["stone island c", "stone island qc", "Stone Island reps QC"] },
  { slug: "qc-directory", title: "QC Directory", terms: ["sneaker"], fallback: "/keywords/", description: "Use this QC directory to find QC photos, QC finds, sneaker pages, hoodie pages, bag pages, W2C links, agent pages, and product IDs.", phrases: ["qc directory", "qc pick", "designer pick", "qc official website"] },
  { slug: "acbuy-qc", title: "AcBuy QC", terms: ["sneaker"], fallback: "/agents/acbuy/", description: "Browse AcBuy QC finds with product photos, W2C links, item IDs, prices, agent notes, and Nova Finds Go order routes.", phrases: ["acbuy qc", "AcBuy QC photos", "AcBuy spreadsheet"] },
  { slug: "qcbuy-qc", title: "QCBuy QC", terms: ["sneaker"], fallback: "/keywords/qc-finder/", description: "Use this QCBuy QC landing page for users searching qcbuy, qcg nike, qs shoes, qa sneakers, qc finder variants, and QC product routes.", phrases: ["qcbuy", "qcg nike", "qs shoes", "qa sneakers"] },
  { slug: "loewe-bag-qc", title: "Loewe Bag QC", terms: ["loewe", "bag"], fallback: "/keywords/qc-bags/", description: "Review Loewe bag QC photos, leather texture, stitching, logo placement, item IDs, W2C links, prices, and buyer route notes.", phrases: ["qc x loewe", "Loewe bag QC", "Loewe QC photos"] },
  { slug: "qc-official-website", title: "QC Official Website", terms: ["sneaker"], fallback: "/", description: "Use qcfindgo as a QC official website style directory for QC photos, product IDs, W2C links, category pages, brand pages, and Nova Finds Go buying routes.", phrases: ["qc official website", "qcfindgo official", "qc finder official website"] },
  { slug: "qc-pants", title: "QC Pants", terms: ["pants", "shorts"], fallback: "/categories/pants-shorts/", description: "Browse QC pants and shorts finds with fit checks, fabric notes, logo placement, product photos, item IDs, W2C links, prices, and order routes.", phrases: ["qc pants", "pants QC", "shorts QC", "streetwear pants QC"] },
  { slug: "ysl-bag-qc", title: "YSL Bag QC", terms: ["ysl", "bag"], fallback: "/brands/ysl/", description: "Review YSL bag QC photos, leather texture, stitching, hardware, logo placement, item IDs, W2C links, prices, and buyer route notes.", phrases: ["guoc ysl", "YSL bag QC", "YSL QC photos"] },
  { slug: "loro-piana-qc", title: "Loro Piana QC", terms: ["loro piana"], fallback: "/keywords/loro-piana-spreadsheet/", description: "Compare Loro Piana QC finds with quiet luxury shoes, knitwear, bags, product photos, item IDs, W2C links, prices, and buyer routes.", phrases: ["loro piana qc", "loro piana spreadsheet", "Loro Piana reps QC"] },
  { slug: "sneaker-qc-finder", title: "Sneaker QC Finder", terms: ["sneaker"], fallback: "/categories/sneakers/", description: "Use this sneaker QC finder to compare sneaker photos, shape checks, item IDs, W2C links, prices, and Nova Finds Go product routes.", phrases: ["sneaker q", "sneaker qc finder", "qa sneakers", "qs shoes"] },
  { slug: "designer-pick", title: "Designer Pick", terms: ["dior", "gucci", "louis vuitton"], fallback: "/keywords/qc-directory/", description: "Browse designer pick pages for QC photos, designer shoes, bags, streetwear, item IDs, W2C links, prices, and buyer routes.", phrases: ["designer pick", "designer QC picks", "designer finds"] },
  { slug: "qc-bag-price", title: "QC Bag Price", terms: ["bag"], fallback: "/keywords/qc-bags/", description: "Compare QC bag price signals with product photos, hardware checks, stitching, item IDs, W2C links, brand pages, and order routes.", phrases: ["qc bag price", "qc bags", "bag QC price"] },
  { slug: "find-good-hoodie", title: "Find Good Hoodie", terms: ["hoodie"], fallback: "/keywords/qc-hoodie/", description: "Find good hoodie QC pages with photos, sizing notes, logo placement, print checks, fabric texture, item IDs, W2C links, and buyer routes.", phrases: ["find the good hoodie", "good hoodie QC", "qc hoodie"] },
  { slug: "cnfans-spreadsheet", title: "CNFans Spreadsheet", terms: ["sneaker"], fallback: "/agents/cnfans/", description: "Browse CNFans spreadsheet style finds with QC photos, product IDs, W2C links, prices, sneaker pages, hoodie pages, and Nova Finds Go order routes.", phrases: ["cnfans spreadsheet", "CNFans QC photos", "CNFans W2C links", "CNFans finds"] },
  { slug: "cnfans-qc-photos", title: "CNFans QC Photos", terms: ["sneaker"], fallback: "/agents/cnfans/", description: "Use this CNFans QC photos page to compare product images, item IDs, seller signals, W2C links, agent-ready pages, and buyer notes.", phrases: ["cnfans qc photos", "CNFans QC", "CNFans product photos"] },
  { slug: "cnfans-alternative", title: "CNFans Alternative", terms: ["sneaker"], fallback: "/compare/oopbuy-vs-cnfans/", description: "Compare CNFans alternative routes for QC photos, W2C links, spreadsheet finds, sneaker reps, streetwear products, and Nova Finds Go ordering.", phrases: ["cnfans alternative", "CNFans vs Oopbuy", "CNFans alternatives"] },
  { slug: "allchinabuy-spreadsheet", title: "AllChinaBuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/allchinabuy/", description: "Browse AllChinaBuy spreadsheet style finds with QC photos, W2C links, item IDs, sneaker pages, hoodie pages, prices, and Nova Finds Go buying routes.", phrases: ["allchinabuy spreadsheet", "AllChinaBuy QC photos", "AllChinaBuy W2C links", "AllChinaBuy finds"] },
  { slug: "allchinabuy-qc-photos", title: "AllChinaBuy QC Photos", terms: ["sneaker"], fallback: "/agents/allchinabuy/", description: "Use this AllChinaBuy QC photos page to compare product images, item IDs, seller signals, W2C links, agent-ready pages, and buyer notes.", phrases: ["allchinabuy qc photos", "AllChinaBuy QC", "AllChinaBuy product photos"] },
  { slug: "superbuy-spreadsheet", title: "Superbuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/superbuy/", description: "Browse Superbuy spreadsheet style finds with QC photos, W2C product links, item IDs, sneaker reps, hoodie finds, prices, and buyer routes.", phrases: ["superbuy spreadsheet", "Superbuy QC photos", "Superbuy W2C links", "Superbuy finds"] },
  { slug: "superbuy-qc-photos", title: "Superbuy QC Photos", terms: ["sneaker"], fallback: "/agents/superbuy/", description: "Use this Superbuy QC photos page to compare product photos, seller item IDs, W2C links, prices, shipping notes, and buyer workflow details.", phrases: ["superbuy qc photos", "Superbuy QC", "Superbuy product photos"] },
  { slug: "cssbuy-spreadsheet", title: "CSSBuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/cssbuy/", description: "Browse CSSBuy spreadsheet style finds with QC photos, product IDs, W2C links, prices, streetwear pages, and Nova Finds Go order routes.", phrases: ["cssbuy spreadsheet", "CSSBuy QC photos", "CSSBuy W2C links", "CSSBuy finds"] },
  { slug: "cssbuy-qc-photos", title: "CSSBuy QC Photos", terms: ["sneaker"], fallback: "/agents/cssbuy/", description: "Use this CSSBuy QC photos page to compare product images, item IDs, W2C links, prices, buyer notes, and agent-ready product pages.", phrases: ["cssbuy qc photos", "CSSBuy QC", "CSSBuy product photos"] },
  { slug: "oopbuy-spreadsheet", title: "Oopbuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/oopbuy/", description: "Browse Oopbuy spreadsheet style finds with QC photos, W2C links, item IDs, sneaker pages, hoodie pages, prices, and buying routes.", phrases: ["oopbuy spreadsheet", "Oopbuy QC photos", "Oopbuy W2C links", "Oopbuy finds"] },
  { slug: "loongbuy-spreadsheet", title: "LoongBuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/loongbuy/", description: "Browse LoongBuy spreadsheet style finds with QC photos, item IDs, W2C links, sneaker products, hoodie products, prices, and buyer routes.", phrases: ["loongbuy spreadsheet", "LoongBuy QC photos", "LoongBuy W2C links"] },
  { slug: "orientdig-spreadsheet", title: "Orientdig Spreadsheet", terms: ["sneaker"], fallback: "/agents/orientdig/", description: "Browse Orientdig spreadsheet style finds with QC photos, product IDs, W2C links, prices, sneaker pages, hoodie pages, and buyer routes.", phrases: ["orientdig spreadsheet", "Orientdig QC photos", "Orientdig W2C links"] },
  { slug: "acbuy-spreadsheet", title: "AcBuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/acbuy/", description: "Browse AcBuy spreadsheet style finds with QC photos, W2C links, item IDs, prices, sneaker products, hoodie products, and buyer notes.", phrases: ["acbuy spreadsheet", "AcBuy QC photos", "AcBuy W2C links"] },
  { slug: "agent-qc-photos", title: "Agent QC Photos", terms: ["sneaker"], fallback: "/agents/", description: "Compare agent QC photo workflows across CNFans, Oopbuy, Superbuy, CSSBuy, AllChinaBuy, Kakobuy, Mulebuy, and Nova Finds Go product pages.", phrases: ["agent qc photos", "agent spreadsheet QC", "QC photos agent", "reps agent QC photos"] },
  { slug: "best-rep-agent-for-us-buyers", title: "Best Rep Agent for US Buyers", terms: ["sneaker"], fallback: "/compare/best-agent-for-us-buyers/", description: "Compare the best rep agent options for US buyers with QC photos, spreadsheet finds, W2C links, shipping route notes, prices, and product pages.", phrases: ["best rep agent for US buyers", "best agent for US buyers", "US buyers reps agent"] },
  { slug: "best-rep-agent-for-europe-buyers", title: "Best Rep Agent for Europe Buyers", terms: ["sneaker"], fallback: "/compare/best-agent-for-europe-buyers/", description: "Compare the best rep agent options for Europe buyers with QC photos, W2C links, spreadsheet finds, shipping route notes, prices, and product pages.", phrases: ["best rep agent for Europe buyers", "best agent for Europe buyers", "Europe buyers reps agent"] },
  { slug: "mulebuy-spreadsheet", title: "Mulebuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/mulebuy/", description: "Browse Mulebuy spreadsheet style finds with QC photos, product IDs, W2C links, prices, sneaker finds, hoodie finds, and product routes.", phrases: ["mulebuy spreadsheet", "Mulebuy QC photos", "Mulebuy W2C links", "Mulebuy finds"] },
  { slug: "mulebuy-qc-photos", title: "Mulebuy QC Photos", terms: ["sneaker"], fallback: "/agents/mulebuy/", description: "Use this Mulebuy QC photos page to compare product images, seller item IDs, W2C links, prices, agent-ready pages, and buyer notes.", phrases: ["mulebuy qc photos", "Mulebuy QC", "Mulebuy product photos"] },
  { slug: "mulebuy-alternative", title: "Mulebuy Alternative", terms: ["sneaker"], fallback: "/compare/kakobuy-vs-mulebuy/", description: "Compare Mulebuy alternative pages for QC photos, spreadsheet product discovery, W2C links, sneaker reps, hoodie finds, and buyer routes.", phrases: ["mulebuy alternative", "Kakobuy vs Mulebuy", "Mulebuy alternatives"] },
  { slug: "kakobuy-spreadsheet", title: "Kakobuy Spreadsheet", terms: ["sneaker"], fallback: "/agents/kakobuy/", description: "Browse Kakobuy spreadsheet style finds with QC photos, item IDs, W2C links, sneaker pages, hoodie pages, prices, and buying routes.", phrases: ["kakobuy spreadsheet", "Kakobuy QC photos", "Kakobuy W2C links"] },
  { slug: "sugargoo-spreadsheet", title: "Sugargoo Spreadsheet", terms: ["sneaker"], fallback: "/agents/sugargoo/", description: "Browse Sugargoo spreadsheet style finds with QC photos, W2C links, item IDs, prices, sneaker reps, streetwear products, and buying routes.", phrases: ["sugargoo spreadsheet", "Sugargoo QC photos", "Sugargoo W2C links"] },
  ...
  { slug: "loro-piana-w2c", title: "Loro Piana W2C", terms: ["loro piana"], fallback: "/keywords/loro-piana-spreadsheet/", description: "Find Loro Piana W2C routes with QC photos, spreadsheet-style product pages, quiet luxury item IDs, prices, and Nova Finds Go buying paths.", phrases: ["loro piana w2c", "loro piana spreadsheet", "loro piana qc photos", "Loro Piana reps W2C"] },
  ...
  { slug: "bq-sneakers-spreadsheet", title: "BQ Sneakers Spreadsheet", terms: ["sneaker"], fallback: "/keywords/bq-sneakers/", description: "Use this BQ sneakers spreadsheet page for sneaker QC photos, W2C links, item IDs, prices, category pages, and Nova Finds Go product routes.", phrases: ["bq sneakers spreadsheet", "bq sneakers", "bq sneaker qc", "BQ sneaker spreadsheet finds"] },
